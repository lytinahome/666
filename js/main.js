...
function update() {
    ...
    y.domain([d3.min(dataTimeFiltered, function(d){ return d["price_usd"]; }) / 1.005,
        d3.max(dataTimeFiltered, function(d){ return d["price_usd"]; }) * 1.005]);
    ...
    function mousemove() {
        ...
        focus.select("text").text(function() { return d3.format("$,")(d["price_usd"].toFixed(2)); });
